# Summary
- Sample PR body for architecture/protected change with ADR linkage requirements satisfied.

# Issue
- Linked issue (primary tracked issue):
- Primary-Issue-Ref: Closes #69
...
- Development-Linkage-Evidence: GitHub issue #69 Development section shows this PR link.
